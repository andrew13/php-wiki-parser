...
class WikiParser_Plugins_ExternalLink implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(WikiParser_Plugins_Externallink::regular_expression,array($this,'replace_callback'),$line);
    }
