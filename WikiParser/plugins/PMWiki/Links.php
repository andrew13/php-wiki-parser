...
class WikiParser_Plugins_PMWiki_Links implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(WikiParser_Plugins_PMWiki_Links::regular_expression,array($this,'replace_callback'),$line);
    }
    ...
    private function replace_callback($matches)
    {
        ...
        if (preg_match(WikiParser_Plugins_PMWiki_Links::external_protocol_regular_expression, $matches[0]))
        {
            //External_link
