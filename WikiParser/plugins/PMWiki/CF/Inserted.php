 ...
 */
class WikiParser_Plugins_PMWiki_CF_inserted implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(pmwiki_cF_inserted::regular_expression,array($this,'replace_callback'),$line);
    }
    
    private function replace_callback($matches)
    {
        return '<ins>' . substr($matches[0],2,-2) . '</ins>';
    }
