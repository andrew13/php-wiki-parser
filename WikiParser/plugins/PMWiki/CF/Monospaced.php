 ...
 */
class WikiParser_Plugins_PMWiki_CF_monospaced implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(pmwiki_cF_monospaced::regular_expression,array($this,'replace_callback'),$line);
    }
    
    private function replace_callback($matches)
    {
        return '<code>' . substr($matches[0],2,-2) . '</code>';
    }
