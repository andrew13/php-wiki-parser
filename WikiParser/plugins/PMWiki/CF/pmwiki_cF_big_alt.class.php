 ...
 */
class pmwiki_cF_big_alt implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(pmwiki_cF_big_alt::regular_expression,array($this,'replace_callback'),$line);
    }
