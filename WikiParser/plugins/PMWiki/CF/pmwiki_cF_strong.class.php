 ...
 */
class pmwiki_cF_strong implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(pmwiki_cF_strong::regular_expression,array($this,'replace_callback'),$line);
    }
