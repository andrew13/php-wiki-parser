 ...
 */
class WikiParser_Plugins_PMWiki_CF_small implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(pmwiki_cF_small::regular_expression,array($this,'replace_callback'),$line);
    }
    
    private function replace_callback($matches)
    {
        return '<span style="font-size:83%">' . substr($matches[0],2,-2) . '</span>';
    }
