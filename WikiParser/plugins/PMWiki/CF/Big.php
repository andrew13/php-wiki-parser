 ...
 */
class WikiParser_Plugins_PMWiki_CF_Big implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(WikiParser_Plugins_PMWiki_CF_Big::regular_expression,array($this,'replace_callback'),$line);
    }
