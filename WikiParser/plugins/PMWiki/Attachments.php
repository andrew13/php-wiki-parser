...
class WikiParser_Plugins_PMWiki_Attachments implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        return preg_replace_callback(WikiParser_Plugins_PMWiki_Attachments::regular_expression,array($this,'replace_callback'),$line);
    }
