...
class WikiParser_Plugins_Table implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        if(preg_match(WikiParser_Plugins_Table::regular_expression_start, $line,$matches))
        {
            //Open table
        ...
        {
            //End of a table.
            if(preg_match(WikiParser_Plugins_Table::regular_expression_end, $line,$matches))
            {
                //Open table
            ...
            if(preg_match(WikiParser_Plugins_Table::regular_expression_row, $line,$matches))
            {
                //Start Row
            ...
            {
                if(preg_match(WikiParser_Plugins_Table::regular_expression_th, $line,$matches))
                {
                    if($matches[2] === "")
                    {
                ...
                if(preg_match(WikiParser_Plugins_Table::regular_expression_td, $line,$matches))
                {
                    if($matches[2] === "")
                    {
