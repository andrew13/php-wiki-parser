...
class WikiParser_Plugins_Lists implements WikiParser_Library_StartOfLineInterface
{
    ...
    public function startOfLine($line)
    {
        ...
        if (!preg_match(WikiParser_Plugins_Lists::regular_expression, $line))
        {
        ...
        return $html . preg_replace_callback(WikiParser_Plugins_Lists::regular_expression,array($this,'replace_callback'),$line);
    }
